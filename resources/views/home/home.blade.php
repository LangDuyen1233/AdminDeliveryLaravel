        ...
        <div class="row">
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="ms-card ms-widget has-graph-full-width ms-infographics-widget">
                    ...
                    <div class="ms-card-body media">
                        <div class="media-body" style="text-align: center">
                            <span class="black-text"><strong>Tổng món ăn</strong></span>
                            <h2>{{$countFood}}</h2>
                        </div>
                    </div>
                    ...
                    <div class="ms-panel-header">
                        <div class="d-flex justify-content-between">
                            <div class="align-self-center align-left">
                                <h6>Danh sách thức ăn bán chạy</h6>
                            </div>
{{--                            <a href="{{route('admin-food.index')}}">--}}
{{--                                <button type="button" class="btn btn-primary">Tất cả--}}
{{--                                </button>--}}
{{--                            </a>--}}
                        </div>
                    </div>
                                ...
                                <div class="ms-card no-margin">
                                    ...
                                    <div class="ms-card-body">
                                        <div class="ms-card-heading-title">
                                            <h6>{{$rs->name}}</h6>
                                            <span ><strong>{{$rs->rating}}</strong><i class="fas fa-star" style="color: yellow"></i></span>
                                        </div>
